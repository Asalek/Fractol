...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/02 14:57:47 by asalek            #+#    #+#             */
/*   Updated: 2022/02/02 20:05:26 by asalek           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	...
	s.color = 0;
	s.mlx_ptr = mlx_init();
	s.win_ptr = mlx_new_window (s.mlx_ptr, X_AXIS, Y_AXIS, "Burning Ship_Set");
	burningship(&s);
